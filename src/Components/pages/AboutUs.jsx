...
import rodrigo from "../../img/RodrigoCardoso.jpg"
...
const AboutUs = () => {
    return (
        ...
        <div >
            <h1 className="text-center mx-5 p-3 title fw-bold" >¿Quiénes somos?</h1>
        ...
        <Row >
        <Col xs={12} md={6} lg={4}>
        <div className="text-center  my-3 mx-3 member container p-3">
       ...
       <Col xs={12} md={6} lg={4}>
        ...
        <Col xs={12} md={6} lg={4}>
        <div className="text-center  my-3 mx-4 member container p-4">
        ...
        <Col xs={12} md={6} lg={4}>
        <div className="text-center  my-3 mx-4 member container p-3 ">
          <img src={rodrigo} alt="Avatar Rodrigo Cardoso" className=" img rounded-circle" />
          <h5 className="my-2 fw-bold">Rodrigo Cardoso</h5>
          <p className="text-center ">Soy Rodrigo Cardoso, tengo 36 años. Soy biotecnólogo, trabajo como analista químico en una industra y en mis tiempos libre enseño matemáticas, física y química. Me gusta hacer trekking e ir al gimnasio. </p>
        </div>
        </Col>
        </Row>
        </Container>
