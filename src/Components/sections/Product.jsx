    ...
    <div>
      <Container>
        <Row className="py-5">
          ...
          <Col lg={6}>
            <div key={productsId._id}>
              ...
              <p>
                <strong className="fs-5">Precio: </strong>
                <span className="fs-3 price">${productsId.price}</span>
              </p>
              <div>
                {productsId.stock > 0 ? (
            ...
            <div>
              {quantityAdded > 0 ? (
                <Link to="/cart" className="finishB fs-4">
                  Terminar Compra
                </Link>
              ) : (
                <Count
        ...
        <div className="mb-5">
          ...
          <hr />
          {productsId.characteristic &&
            productsId.characteristic.map((elem, index) => (
              <p key={index}> - {elem}</p>
            ))}
        </div>
      </Container>
